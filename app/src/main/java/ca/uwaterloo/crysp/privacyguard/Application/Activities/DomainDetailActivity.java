...
public class DomainDetailActivity extends AppCompatActivity {
    ...
    private DetailDomainListViewAdapter adapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        notificationSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                DatabaseHandler db = DatabaseHandler.getInstance(DomainDetailActivity.this);
                if (isChecked) {
    ...
    private void updateList() {
        ...
        List<DomainAlert>  alerts = db.getAppDomainAlerts(packageName);
        ...
        if (adapter == null) {
            adapter = new DetailDomainListViewAdapter(this, alerts);

            View header = getLayoutInflater().inflate(R.layout.listview_detail_domain, null);
            ...
            ((TextView) header.findViewById(R.id.detail_score)).setText(R.string.score_label);
            ((TextView) header.findViewById(R.id.detail_isdga)).setText(R.string.isdga_label);
